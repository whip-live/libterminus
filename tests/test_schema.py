...
def test_schema_with_valid_data(encoded_jwt):
    ...
    data = {
        ...
        "typology": "moto",
        "jwt": encoded_jwt,
        "path": {"coordinates": [[0.00001, 0.00001], [0.00002, 0.00002]]},
        "points": [
            {
                "sequence_id": 1,
                "ele": 12,
...
def test_match_segment_schema():
    ...
    data = {
        "segment_id": {
            ...
            "sectors": [
                {
                    "id": "4fe8c832-13be-43b1-b358-3558d32f4b82",
                    "name": "Sector 1",
                    "start_index": 1,
                    "end_index": 2,
                },
                {
                    "id": "baa9ec35-c982-4934-a72b-fc3565313802",
                    "name": "Sector 2",
                    "start_index": 2,
                    "end_index": 3,
                },
                {
                    "id": "98f211b7-3fd6-4843-8b0a-75033373e38c",
                    "name": "Sector 3",
                    "start_index": 3,
                    "end_index": 4,
                },
...
def test_match_recording_schema(encoded_jwt):
    ...
    data = {
        ...
        "bbox": (0, 0, 1, 1),
        "path": {
            "coordinates": [[0.00001, 0.00001], [0.00002, 0.00002], [0.00003, 0.00003]]
        },
        "points": [
...
def test_recordings_to_match_schema_works(encoded_jwt):
    ...
    data = {"recordings": [recording], "segments": [segment]}
    result = RecordingsToMatchSchema().load(data)
    assert result.errors == {}
...
def test_areas_to_match_schema(encoded_jwt):
    ...
    data = {"areas": [area], "recordings": [recording]}
    result = AreasToMatch().load(data)
    assert result.errors == {}
